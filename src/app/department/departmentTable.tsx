...
const DepartmentTable: React.FC = () => {
  ...
  <div className="flex justify-between items-center mb-4">
    ...
    >
      <FaPlus className="inline-block mr-2" /> Add Department
    </button>
  </div>

  <div className="bg-white shadow-md rounded-lg overflow-x-auto max-w-full sm:max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-5xl">
